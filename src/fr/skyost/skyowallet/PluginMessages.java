...
public class PluginMessages extends Skyoconfig {
	...
	public String message14 = ChatColor.AQUA + "You are the owner of /bank/.";
	...
	public String message20 = ChatColor.RED + "You bank (/bank/) has been deleted. You have now /amount/ /currency-name/ in your wallet.";
	...
	public String message22 = "You have /members/ in your bank.";
	@ConfigOptions(name = "messages.23")
	public String message23 = "There are /members/ in the specified bank.";
	...
	public String message26 = ChatColor.GREEN + "You have left your bank. You have /amount/ /currency-name/ in your wallet.";
	...
	public String message29 = ChatColor.RED + "But as an admin, you can perform this action if you specify the bank.";
	@ConfigOptions(name = "messages.30")
	public String message30 = ChatColor.GOLD + "You are now an owner of the bank " + ChatColor.AQUA + "/bank/" + ChatColor.GOLD + " !";
	@ConfigOptions(name = "messages.31")
	public String message31 = ChatColor.RED + "You are not an owner of /bank/ anymore !";
